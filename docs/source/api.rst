...
The main application class ``ZarrDataViewerApp`` provides the following key methods:
...
For detailed implementation, see the source code in ``src/zarr_data_viewer.py``.